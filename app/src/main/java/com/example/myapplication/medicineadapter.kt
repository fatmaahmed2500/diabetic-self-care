...
class medicineadapter (var context: Context, var arrayList: ArrayList<medicineitem>) :
    RecyclerView.Adapter<medicineadapter.ItemHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        val charItem: medicineitem = arrayList.get(position)
