...
class Alphaadapter2 (var context: Context, var arrayList: ArrayList<Charitem2>) :
    RecyclerView.Adapter<Alphaadapter2.ItemHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        val charItem: Charitem2 = arrayList.get(position)
