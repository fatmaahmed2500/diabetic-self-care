...
class breakadapter (var context: Context, var arrayList: ArrayList<breakitem>) :
    RecyclerView.Adapter<breakadapter.ItemHolder>() {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        val charItem: breakitem = arrayList.get(position)
